<div class="bottom-footer">
	...
	<div class="versions">
		...
		<div>Casper Network Node version: 1.4.8 (72b698e89)</div>
...
<style lang="postcss">
	.bottom-footer {
		@apply relative py-[clamp(16px,1.43vw,1.43vw)] px-[clamp(16px,3.75vw,3.75vw)] flex;
		/* remove */
		@apply h-[clamp(50px,5.71vw,5.71vw)];
	}
