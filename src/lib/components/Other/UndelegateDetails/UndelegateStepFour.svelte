...
<div class="title">Undelegation Completed!</div>
<div class="deploy">
	<div class="hash">
...
<div class="sender">
	...
	<div class="value validator-display">
		<div class="validator-hash">
			...
			<Hash color="black" noOfCharacters={8} hash={validatorPublicKey || ''} />
			<div class="copy-icon">
...
<style lang="postcss">
	...
	.value {
		...
		@apply px-[clamp(16px,1.25vw,1.25vw)] py-[clamp(14px,0.95vw,0.95vw)];
