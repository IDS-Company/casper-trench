...
<div class="title">Sign Undelegation</div>
<div class="sender">
	<div class="top">
		<div>Deploy Hash</div>
	</div>
	<div class="value grey">
		<span
			...
			<div class="md:hidden">
				<Hash color="black" noOfCharacters={16} hash={deployHash || ''} />
			</div>
			<div class="copy-icon">
				{#if deployHash}
...
<div class="sender">
	...
	<div class="value grey">
		<span
			><div class="hidden md:block">
				<Hash start color="black" noOfCharacters={100} hash={validatorPublicKey || ''} />
			</div>
			<div class="md:hidden">
...
<div class="sender">
	<div class="top">
		<div>Validator Account Hash</div>
	</div>
	<div class="value grey">
		<span
			><div class="hidden md:block">
